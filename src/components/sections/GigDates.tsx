const upcomingShows = [
  ...
  { date: "28 jun 2026", venue: "Gluren bij de Buren", city: "Herten" },
  { date: "8 aug 2026", venue: "HEIJ", city: "St. Odilienberg",   ticketUrl: "https://www.heijfestival.nl/#tickets" },
];
          ...
          {upcomingShows.map((show) => (
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-8">
                <span className="text-sm font-mono text-fg-inverse-muted w-28 shrink-0">
                  {show.date}
                </span>
              ...
              {show.ticketUrl && (
                <a
                  href={show.ticketUrl}
                  className="self-start sm:self-auto px-5 py-2 bg-accent text-on-accent text-xs font-bold tracking-widest uppercase rounded hover:bg-accent-hover transition-colors"
                >
                  Tickets
                </a>
              )}
