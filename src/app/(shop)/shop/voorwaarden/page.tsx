...
export const metadata: Metadata = {
  ...
  description:
    "Algemene voorwaarden voor bestellingen in de SideTrack webshop.",
};
  ...
  return (
    <div className="bg-base min-h-screen">
      <div className="max-w-2xl mx-auto px-4 py-16">
        ...
        <p className="text-fg-subtle mb-10 text-sm">
          SideTrack Shop — Roermond
        </p>
        ...
        <div className="space-y-8 text-sm text-fg-muted leading-relaxed">
          <div>
            ...
            <p>
              ...
              bestelling. Door een bestelling te plaatsen reserveer je een
              artikel; betaling vindt <em>niet</em> automatisch plaats bij het
              afrekenen.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              Wij nemen hiervoor contact met je op via het opgegeven e-mailadres
              of telefoonnummer. Betaling dient te worden voldaan{" "}
          ...
          <div>
            <h2 className="text-base font-bold text-fg mb-3">
              3. Annulering door SideTrack
            </h2>
            <p>
              SideTrack behoudt zich het recht voor om een bestelling te
              annuleren in de volgende gevallen:
            </p>
            <ul className="list-disc list-inside mt-3 space-y-1.5">
              ...
              <li>
                Er worden meer bestellingen geplaatst dan er artikelen
                beschikbaar zijn en jouw bestelling valt buiten de beschikbare
                voorraad.
              </li>
              <li>
                Er zijn onvoorziene omstandigheden waardoor levering niet
                mogelijk is.
              </li>
            </ul>
            <p className="mt-3">
              In geval van annulering door SideTrack ontvang je hierover
              bericht. Er zijn geen kosten verbonden aan een dergelijke
              annulering, aangezien er nog geen betaling heeft plaatsgevonden.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              je bestelling annuleren door contact met ons op te nemen via de
              contactinformatie op de{" "}
              <a
                href="/#contact"
          ...
          <div>
            ...
            <p>
              ...
              leveren. Een exacte levertijd kunnen wij op voorhand niet
              garanderen. Wij communiceren de verwachte levertijd bij
              bevestiging.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Vragen over je bestelling of deze voorwaarden? Neem contact met
              ons op via de contactinformatie op de{" "}
              <a
                href="/#contact"
                className="underline hover:text-fg transition-colors"
              >
